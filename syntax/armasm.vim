...
syn match armasmImmediate       "#[a-zA-Z_]*"
...
syn region armasmMultilineComment start="/\*" end="\*/" contains=armasmTodo
...
syn keyword armasmDirective ADDRESS ALIGN AREA ARM ASSERT CN CODE16 CODE32 CP
...
syn keyword armasmDirective THUMB TTL WEND WHILE
...
if version >= 508 || !exists("did_armasm_syntax_inits")
    ...
    HiLink armasmMultilineComment   Comment
    ...
    HiLink armasmIdentifier         Special

    HiLink armasmImmediate          Constant
